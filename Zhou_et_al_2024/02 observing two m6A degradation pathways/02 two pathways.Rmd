...
## HEK HLs data
HEK_hls <- read.csv(paste0(path.to.data, "HEK.4SU.HL.one.csv"))
HEK_hls_2 <- read.csv(paste0(path.to.data, "HEK.4SU.HL.two.csv"))
...
hl_mESC <- read.table("~/Desktop/Data/mESC half life/halflife_changes_WTvsKO.txt", 
                        header = T)
