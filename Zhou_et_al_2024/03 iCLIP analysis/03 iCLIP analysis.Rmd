...
can be found in the paper [Körtel et al., 2021](https://doi.org/10.1093/nar/gkab485)). 
...
da_STMvsYTHDF2_STM <- 
    readRDS("~/Desktop/Project/miCLIPs/m6A degradation/10 YTHDF2 RNAseq/rds/da_STMvsYTHDF2_STM.rds") %>% 
    as.data.frame(.) %>%
    filter(baseMean >= basemean)
