---
title: "05 Target gene and p-body analysis"
author: "You Zhou"
...
# DCP2
## load data
df_sample <- readxl::read_xlsx("~/Desktop/Data/GEO/DCP2_HEK/sample_name.xlsx")
df_sample %>% as.data.frame(.)

df_count <- read.table("~/Desktop/Data/GEO/DCP2_HEK/count_dcp2.txt",
                       header = T)[,c(1, 7:12)]
...
## CNOT1
df.cnot <- 
    read.csv("~/Desktop/Data/GEO/CNOT1 KD/gene_count_matrix.csv")[,c(1,6,7,10,11)]
